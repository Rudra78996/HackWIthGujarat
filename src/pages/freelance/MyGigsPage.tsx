            ...
            <div key={gig._id} className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  ...
                  >
                    <Users size={16} />
                    <span>{gig.applications.length} Applications</span>
                      ...
                      {gig.applications.map((application) => (
                        <div key={application._id} className="bg-gray-50 rounded-lg p-4">
                          <div className="flex justify-between items-start">
                            <div>
                              <div className="flex items-center space-x-2">
                                <h5 className="font-medium">{application.user.name}</h5>
                              ...
                              <p className="text-gray-600 mt-2">{application.coverLetter}</p>
                              <p className="text-sm text-gray-500 mt-2">
                                Proposed Budget: ${application.proposedBudget}/hr
                              </p>
